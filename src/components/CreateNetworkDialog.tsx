...
export function CreateNetworkDialog({ onNetworkCreated }: CreateNetworkDialogProps) {
  ...
  const loadOptions = async () => {
    ...
    try {
      ...
      if (rolesArray.length > 0) {
        console.log(
          `✓ Loaded ${rolesArray.length} roles for network creation:`,
          rolesArray.map((r) => r.name).join(', ')
        );
      } else {
        console.log(
          '⚠ No roles available for network creation - users may need to create roles first'
        );
      }
    } catch (err) {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      if (
        ...
        (!formData.defaultRole || formData.defaultRole === 'none')
      ) {
        throw new Error(
          'A default user role is required when captive portal is disabled. Please select a role in the Security tab.'
        );
      }
      ...
      const serviceData: Partial<Service> = generateDefaultService({
        ...
        defaultTopology:
          formData.topology && formData.topology !== 'none' ? formData.topology : undefined,
  ...
  const securityRequiresPassphrase = [
    'wpa2-personal',
    'wpa-personal',
    'wpa3-personal',
    'wpa3-sae',
            ...
            <TabsContent value="advanced" className="space-y-4 mt-4">
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg">
                <div className="space-y-0.5">
                  ...
                  <p className="text-xs text-muted-foreground">Require web portal authentication</p>
                </div>
                <Switch
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg">
                <div className="space-y-0.5">
                  ...
                  <p className="text-xs text-muted-foreground">Enable fast roaming assistance</p>
                </div>
                <Switch
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange('preAuthTimeout', parseInt(e.target.value) || 300)
                  }
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange('postAuthTimeout', parseInt(e.target.value) || 1800)
                  }
                />
              </div>
            </TabsContent>
            ...
            {activeTab !== 'advanced' ? (
              ...
              <Button
                ...
                disabled={
                  ...
                  !formData.ssid ||
                  (securityRequiresPassphrase && !formData.passphrase)
                }
              >
                {creating ? (
                  <>
