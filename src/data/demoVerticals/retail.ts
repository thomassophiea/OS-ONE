...
export const RETAIL_VERTICAL: VerticalDemoProfile = {
  ...
  aaaPolicies: [
    ...
    {
      id: 'svc-mrd-bf-store',
      serviceName: 'STORE-WIFI',
      ssid: 'STORE-WIFI',
      enabled: true,
      description: 'Legacy store WiFi — pre-digital-transformation (do not delete, POS fallback)',
      band: 'all',
      vlan: 99,
      maxClients: 128,
      maxClientsPer24: 0,
      ...
      canDelete: false,
      defaultVlanId: '99',
      defaultAuthRoleId: 'role-unclassified',
      defaultUnauthRoleId: 'role-deny',
      proxied: 'Local',
      security: {
        type: 'wpa2-personal',
      ...
      WpaPskElement: {
        mode: 'wpa2-personal',
        pmfMode: 'disabled',
        presharedKey: 'Mer1d14n@St0re!',
        keyType: 'ASCII',
      },
      mbaEnabled: false,
      createdAt: '2019-08-12T07:00:00Z',
      updatedAt: '2021-11-03T11:00:00Z',
    },
    {
      id: 'svc-mrd-bf-signage',
      serviceName: 'MRDG_PROMO',
      ssid: 'MRDG_PROMO',
      enabled: false,
      description: 'Promotional display network — decommissioned Q4 2023, pending cleanup',
      band: 'all',
      vlan: 150,
      maxClients: 32,
      maxClientsPer24: 0,
    ...
    {
      id: 'svc-mrd-bf-mgmt',
      serviceName: 'MRDG_MGMT_OLD',
      ssid: 'MRDG_MGMT',
      enabled: true,
      description: 'Store management — migrated to Meridian-Staff, retained for legacy scanners',
      band: 'all',
      vlan: 20,
      maxClients: 48,
      maxClientsPer24: 16,
      ...
      mbaEnabled: true,
      createdAt: '2020-07-20T08:00:00Z',
